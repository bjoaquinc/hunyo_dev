  ...
  <div style="height: 100%">
    ...
    >
      ...
      <div class="q-mt-lg">
        Welcome to Hunyo!<br />
        <br />
        These Terms of Use (or “Terms”) govern your access to and use of our
        services, including SMS, APIs, email notifications, applications,
        buttons, widgets, ads, and commerce services (collectively, the
      ...
      <div class="text-h5 q-mt-md">1. Who May Use the Services</div>
      <div class="q-mt-md">
        You may use the Services only if you agree to form a binding contract
        with Hunyo and are not a person barred from receiving services under the
        laws of the applicable jurisdiction. In any case, you must be at least
        16 years old to use the Services. If you are accepting these Terms and
      ...
      <div class="text-h5 q-mt-md">2. Privacy</div>
      <div class="q-mt-md">
        Our
        <span
          ><q-btn
        ...
        of this information, including the transfer of this information to the
        Philippines and/or other countries for storage, processing and use by
        Hunyo and its affiliates.
      </div>
      <div class="text-h5 q-mt-md">3. Content on the Services</div>
      <div class="q-mt-md">
        ...
        or harassment. Information regarding specific policies and the process
        for reporting or appealing violations can be found in our
        <span
          ><q-btn
            flat
            color="primary"
        ...
        constitutes copyright infringement, please report this by emailing us at
        hello@hunyo.com
      </div>
      ...
      <div class="q-mt-md">
        ...
        to the rest of the world and to let others do the same. You agree that
        this license includes the right for Hunyo to provide, promote, and
        ...
        the syndication, broadcast, distribution, Recommendation, promotion or
        publication of such Content on other media and services, subject to our
        terms and conditions for such Content use. Such additional uses by
        Hunyo, or other companies, organizations or individuals, is made with no
        ...
        compensation for the Content and grant of rights herein.<br />
        <br />
        Hunyo has an evolving set of rules for how ecosystem partners can
        interact with your Content on the Services. These rules exist to enable
        an open ecosystem with your rights in mind. You understand that we may
        modify or adapt your Content as it is distributed, syndicated,
        published, or broadcast by us and our partners and/or make changes to
        your Content in order to adapt the Content to different media.<br />
        <br />
        ...
        display on or through the Services. You agree that such Content will not
        ...
        to post the material and to grant Hunyo the license described above.
      </div>
      <div class="text-h5 q-mt-md">4. Using the Services</div>
      <div class="q-mt-md">
        Please review the
        <span
          ><q-btn
            ...
            no-caps
            class="text-weight-bold"
            >Hunyo Community Guidelines</q-btn
          ></span
        >
        which are part of the User Agreement and outline what is prohibited on
        the Services. You may use the Services only in compliance with these
        Terms and all applicable laws, rules and regulations.<br />
        <br />
        ...
        temporarily) providing the Services or any features within the Services
        to you or to users generally. We also retain the right to create limits
        ...
        terminate users, and reclaim usernames without liability to you. Hunyo
        may offer certain services or features for a fee; by paying for or using
        one of these services, you agree to any additional terms applicable to
        that service.<br />
        <br />
        In consideration for Hunyo granting you access to and use of the
        Services, you agree that Hunyo and its third-party providers and
        ...
        you or others. You also agree not to misuse our Services, for example,
        by interfering with them or accessing them using a method other than the
        interface and the instructions that we provide. You may not do any of
        the following while accessing or using the Services: (i) access, tamper
        with, or use non-public areas of the Services, Hunyo’s computer systems,
        or the technical delivery systems of Hunyo’s providers; (ii) probe,
        ...
        published interfaces that are provided by Hunyo (and only pursuant to
        the applicable terms and conditions), unless you have been specifically
        allowed to do so in a separate agreement with Hunyo (NOTE: crawling the
        ...
        consent of Hunyo is expressly prohibited); (iv) forge any TCP/IP packet
        header or any part of the header information in any email or posting, or
        ...
        (v) protect the rights, property or safety of Hunyo, its users and the
        public. Hunyo does not disclose personally-identifying information to
      ...
      <div class="text-h5 q-mt-md">Your Account</div>
      <div class="q-mt-md">
        ...
        loss or damage arising from your failure to comply with the above.<br />
        <br />
      ...
      <div class="text-h5 q-mt-md">Your License to Use the Services</div>
      <div class="q-mt-md">
        Hunyo gives you a personal, worldwide, royalty-free, non-assignable and
        ...
        enjoy the benefit of the Services as provided by Hunyo, in the manner
        permitted by these Terms.<br />
        <br />
        The Services are protected by copyright, trademark, and other laws of
        both the Philippines and other countries. Nothing in the Terms gives you
        a right to use the Hunyo name or any of the Hunyo trademarks, logos,
        ...
        Hunyo and its licensors. Any feedback, comments, or suggestions you may
        provide regarding Hunyo, or the Services is entirely voluntary and we
        will be free to use such feedback, comments or suggestions as we see fit
        and without any obligation to you.
      </div>
      <div class="text-h5 q-mt-md">Ending these Terms</div>
      <div class="q-mt-md">
        You may end your legal agreement with Hunyo at any time by deactivating
        ...
        <span
          ...
          ></span
        >
        for instructions on how to deactivate your account and the
        <span
          ><q-btn
            flat
            color="primary"
          ...
          ></span
        >
        for more information on what happens to your information.<br />
        <br />
        ...
        Terms or the Hunyo Community Guidelines, (ii) you create risk or
        possible legal exposure for us; (iii) your account should be removed due
        to unlawful conduct, (iv) your account should be removed due to
        prolonged inactivity; or (v) our provision of the Services to you is no
        longer commercially viable. We will make reasonable efforts to notify
        you by the email address associated with your account or the next time
        you attempt to access your account, depending on the circumstances. In
        all such cases, the Terms shall terminate, including, without
        limitation, your license to use the Services, except that the following
        sections shall continue to apply: 2, 3, 5, and 6. If you believe your
        account was terminated in error you can file an appeal by messaging us
        at hello@hunyo.com. For the avoidance of doubt, these Terms survive the
        deactivation or termination of your account.
      </div>
      <div class="text-h5 q-mt-md">
        5. Disclaimers and Limitations of Liability
      </div>
      <div class="text-h5 q-mt-md">The Services are Available “AS-IS”</div>
      <div class="q-mt-md">
        ...
        an “AS IS” and “AS AVAILABLE” basis. The “Hunyo Entities” refers to
        Hunyo, its affiliates, related companies, owners, employees, agents,
        ...
        HUNYO ENTITIES DISCLAIM ALL WARRANTIES AND CONDITIONS, WHETHER EXPRESS
        OR IMPLIED, OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR
        NON-INFRINGEMENT. The Hunyo Entities make no warranty or representation
        ...
        Services or any Content; (ii) any harm to your computer system, loss of
        data, or other harm that results from your access to or use of the
        Services or any Content; (iii) the deletion of, or the failure to store
        ...
        be available on an uninterrupted, secure, or error-free basis. No advice
        or information, whether oral or written, obtained from the Hunyo
        Entities or through the Services, will create any warranty or
        representation not expressly made herein.
      </div>
      <div class="text-h5 q-mt-md">Limitation of Liability</div>
      <div class="q-mt-md">
        TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE HUNYO ENTITIES
        ...
        IN NO EVENT SHALL THE AGGREGATE LIABILITY OF THE HUNYO ENTITIES EXCEED
        THE GREATER OF FIVE THOUSAND PHILIPPINE PESOS (PHP 5,000) OR THE AMOUNT
        YOU PAID HUNYO, IF ANY, IN THE PAST SIX MONTHS FOR THE SERVICES GIVING
        RISE TO THE CLAIM. THE LIMITATIONS OF THIS SUBSECTION SHALL APPLY TO ANY
        THEORY OF LIABILITY, WHETHER BASED ON WARRANTY, CONTRACT, STATUTE, TORT
        (INCLUDING NEGLIGENCE) OR OTHERWISE, AND WHETHER OR NOT THE HUNYO
      ...
      <div class="text-h5 q-mt-md">6. General</div>
      <div class="q-mt-md">
        ...
        always be at hunyo.com ***(<span
          ><q-btn
            ...
            no-caps
            class="text-weight-bold"
            >https://hunyo.com/settings/terms/</q-btn
          ></span
        >)*** will govern our relationship with you. We will try to notify you
        of material revisions, for example via a service notification or an
        email to the email associated with your account. By continuing to access
        or use the Services after those revisions become effective, you agree to
        be bound by the revised Terms.<br />
        <br />
        The laws of the Republic of the Philippines, excluding its choice of law
        provisions, will govern these Terms and any dispute that arises between
        you and Hunyo. All disputes related to these Terms or the Services will
        be brought solely in the proper courts located in Makati City, Metro
        Manila, Republic of the Philippines, and you consent to personal
        jurisdiction and waive any objection as to inconvenient forum.<br />
        <br />
        ...
        will remain in full force and effect. Hunyo’s failure to enforce any
        right or provision of these Terms will not be deemed a waiver of such
        right or provision.<br />
        <br />
        These Terms are an agreement between you and Hunyo, Inc., Level 10-1
        Fort Legend Tower, 31st street & 3rd avenue, Bonifacio Global City,
        1632, Metro Manila, Philippines. If you have any questions about these
        Terms, please contact us at hello@hunyo.com.<br />
        <br />
        <span><div style="font-weight: bold">Effective:</div></span> January
        1st, 2022
      </div>
    </div>
  </div>
